...
void main(void) {
    ...
    LCD_putrs(" Tiempo: ");
    do { if ( 1 == 0 ) { do { LCD_Write( (0x80 + 9 & 0xF0) >> 4 ); LCD_Write( 0x80 + 9 & 0x0F); } while ( 0 ); } else if ( 1 == 1 ) { do { LCD_Write( (0xC0 + 9 & 0xF0) >> 4 ); LCD_Write( 0xC0 + 9 & 0x0F); } while ( 0 ); } else if ( 1 == 2 ) { do { LCD_Write( (0x94 + 9 & 0xF0) >> 4 ); LCD_Write( 0x94 + 9 & 0x0F); } while ( 0 ); } else if ( 1 == 3 ) { do { LCD_Write( (0xD4 + 9 & 0xF0) >> 4 ); LCD_Write( 0xD4 + 9 & 0x0F); } while ( 0 ); } } while ( 0 );
    LCD_putrs("00:00");
    ...
    while (1) {
        ...
        do { if ( 0 == 0 ) { do { LCD_Write( (0x80 + 9 & 0xF0) >> 4 ); LCD_Write( 0x80 + 9 & 0x0F); } while ( 0 ); } else if ( 0 == 1 ) { do { LCD_Write( (0xC0 + 9 & 0xF0) >> 4 ); LCD_Write( 0xC0 + 9 & 0x0F); } while ( 0 ); } else if ( 0 == 2 ) { do { LCD_Write( (0x94 + 9 & 0xF0) >> 4 ); LCD_Write( 0x94 + 9 & 0x0F); } while ( 0 ); } else if ( 0 == 3 ) { do { LCD_Write( (0xD4 + 9 & 0xF0) >> 4 ); LCD_Write( 0xD4 + 9 & 0x0F); } while ( 0 ); } } while ( 0 );
        LCD_putrs(buffer);
