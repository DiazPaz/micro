...
void checar_boton(void){
    static _Bool boton_presionado = 0;
...
void mover_nubes(void){
    for(uint8_t i = 0; i < 3; i++){
        do { if ( 0 == 0 ) { do { LCD_Write( (0x80 + nubes[i] & 0xF0) >> 4 ); LCD_Write( 0x80 + nubes[i] & 0x0F); } while ( 0 ); } else if ( 0 == 1 ) { do { LCD_Write( (0xC0 + nubes[i] & 0xF0) >> 4 ); LCD_Write( 0xC0 + nubes[i] & 0x0F); } while ( 0 ); } else if ( 0 == 2 ) { do { LCD_Write( (0x94 + nubes[i] & 0xF0) >> 4 ); LCD_Write( 0x94 + nubes[i] & 0x0F); } while ( 0 ); } else if ( 0 == 3 ) { do { LCD_Write( (0xD4 + nubes[i] & 0xF0) >> 4 ); LCD_Write( 0xD4 + nubes[i] & 0x0F); } while ( 0 ); } } while ( 0 );
        LCD_putrs(" ");
